...
describe Searcher do
  ...
  it 'should be able to download links' do
    @searcher.download_links(@tmpdir)

    files = [
      {
          :path => @tmpdir.join("Sons of Anarchy - 06x13 - A Mother's Work.WEB-DL.English.orig.srt"),
          :md5  => 'c9c11b17ade210292e635e7389e6fee2'
      },
      {
          :path => @tmpdir.join("Sons of Anarchy.S06E13.HDTV.x264-2HD.srt"),
